...
const GENERIC_MESSAGE = "If that email has an admin login, we've sent a link to reset the password.";
  ...
  if (admin) {
    ...
    if (!recentlySent) {
      ...
      await sendAdminEmail(
        ...
        `<p>Someone requested a password reset for this Kiowa Gun Club admin login.</p>
